...
$UserManagedIdentityResourceId = "/subscriptions/49a8be25-7877-4460-a634-7c9c60a5be08/resourceGroups/machineconfig-demo-rg/providers/Microsoft.ManagedIdentity/userAssignedIdentities/machineconfig-identity"
